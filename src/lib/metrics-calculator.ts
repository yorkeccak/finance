...
const TIME_ESTIMATES = {
  SOURCE_FINDING_BASE: 5,
  SOURCE_FINDING_PER_SOURCE: 3,
  SOURCE_READING_BASE: 15,
  SOURCE_READING_PER_SOURCE: 10,
  WRITING_PER_WORD: 0.15,
  CSV_BASE: 20,
  CSV_PER_ROW: 0.3,
  CHART_PER_CHART: 60,
  ANALYSIS_PER_BLOCK: 45,
  DATA_PROCESSING_PER_EXECUTION: 90,
};
