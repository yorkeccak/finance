 ...
 * Implements clean, professional formatting for financial analysis reports
 */
export async function generateChatPDF(
  ...
  const {
    title = 'Finance AI Analysis Report',
  ...
  for (let i = 1; i <= totalPages; i++) {
    ...
    // Left side - branding
    pdf.text('Generated by Finance AI', margin, pageHeight - 10);
  ...
  const filename = `finance-analysis-${timestamp}.pdf`;
